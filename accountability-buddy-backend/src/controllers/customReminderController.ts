...
export const createReminder = catchAsync(
  async (
    req: CustomRequest<{}, any, { reminderMessage: string; reminderTime: string; recurrence?: string }>,
    res: Response
  ) => {
...
export const updateReminder = catchAsync(
  async (
    req: CustomRequest<{ reminderId: string }, any, { reminderMessage?: string; reminderTime?: string; recurrence?: string }>,
    res: Response
  ) => {
