...
router.post(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      await subscriptionController.createSubscriptionSession(req, res);
    } catch (error) {
...
router.get(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      await subscriptionController.checkSubscriptionStatus(req, res);
    } catch (error) {
...
router.get(
  ...
  async (req: Request, res: Response): Promise<void> => {
    res.status(200).json({ success: true, msg: "This is premium content available to subscribed users." });
  }
);
...
router.get(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      await subscriptionController.getCurrentSubscription(req, res);
    } catch (error) {
...
router.post(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      await subscriptionController.upgradeSubscription(req, res);
    } catch (error) {
...
router.post(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      await subscriptionController.handleStripeWebhook(req, res);
    } catch (error) {
