    ...
    datasets: [
      {
        ...
        data: analytics
          ? [analytics.completedGoals, analytics.pendingGoals]
          : [],
      ...
      {analytics && (
        <div className="charts-container">
          <div className="chart-item" aria-label="Goals Overview Chart">
            ...
            <Bar
              data={goalsChartData}
              aria-label="Bar chart showing completed and pending goals"
            />
          </div>
          ...
          <div className="chart-item" aria-label="Milestone Progress Chart">
            ...
            <Bar
              ...
              aria-label="Bar chart showing completed and total milestones"
            />
          </div>
