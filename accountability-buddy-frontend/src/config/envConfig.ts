...
const envConfig = {
  ...
  requestTimeout: parseInt(
    process.env.REACT_APP_REQUEST_TIMEOUT || '15000',
    10
  ...
  securityHeaders: {
    contentSecurityPolicy:
      process.env.REACT_APP_CSP || "default-src 'self'; script-src 'self';",
    xFrameOptions: process.env.REACT_APP_X_FRAME_OPTIONS || 'SAMEORIGIN',
    strictTransportSecurity:
      process.env.REACT_APP_HSTS || 'max-age=31536000; includeSubDomains',
  },
