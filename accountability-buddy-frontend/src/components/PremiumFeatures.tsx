...
import StripeCheckout from "../../src/components/StripeCheckout"; // Import the StripeCheckout component
...
const PremiumFeatures: React.FC = () => {
  ...
  return (
    <div className="premium-features">
      ...
      {isPremium ? (
        <p>Thank you for being a Premium member! Enjoy your exclusive features.</p>
      ) : (
        <>
          <p>Upgrade to Premium to unlock all features and enhance your experience.</p>
