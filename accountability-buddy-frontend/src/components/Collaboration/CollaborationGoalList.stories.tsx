...
import { CollaborationGoalListProps, CollaborationGoal } from "./Collaboration.types";
...
const Template: StoryFn<typeof CollaborationGoalList> = (args) => <CollaborationGoalList {...args} />;
