export const validatePremiumFeature = (feature: string, allowedFeatures: string[]): boolean => {
  ...
  export const recommendPlan = (plans: { name: string; isRecommended?: boolean }[]): string | null => {
