...
describe("Recommendations Components", () => {
  describe("GroupRecommendations", () => {
    const mockGroups = [
      { id: "1", name: "React Enthusiasts", description: "Learn React together", membersCount: 25 },
      { id: "2", name: "Fitness Fans", description: "Share fitness tips and goals", membersCount: 40 },
    ];
    const mockOnJoinGroup = jest.fn();

    it("renders group recommendations correctly", () => {
      render(<GroupRecommendations recommendations={mockGroups} onJoinGroup={mockOnJoinGroup} />);
  ...
  describe("IndividualRecommendations", () => {
    ...
    it("renders individual recommendations correctly", () => {
      render(<IndividualRecommendations recommendations={mockIndividuals} onConnect={mockOnConnect} />);
