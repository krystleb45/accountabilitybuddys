...
describe("MilitarySupport Component", () => {
  ...
  test("renders the peer support chat button", () => {
    ...
    const chatButton = screen.getByRole("button", { name: /join peer support chat/i });
  ...
  test("displays a disclaimer message", () => {
    ...
    const disclaimer = screen.getByText(/this platform does not provide professional counseling/i);
  ...
  test("displays a feedback form button", () => {
    ...
    const feedbackButton = screen.getByRole("button", { name: /submit feedback/i });
