    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 p-6">
      ...
      <main className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-gray-600 mb-4">Keep track of your goals and milestones.</p>
        ...
        <section className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-gray-600 mb-4">See what you've accomplished recently.</p>
        ...
        <section className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-gray-600 mb-4">See how you rank among your peers.</p>
